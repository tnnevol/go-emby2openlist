...
<div align="center">
  <a href="https://github.com/AmbitiousJun/go-emby2openlist/tree/v2.1.2"><img src="https://img.shields.io/github/v/tag/AmbitiousJun/go-emby2openlist"></img></a>
  <a href="https://hub.docker.com/r/ambitiousjun/go-emby2openlist/tags"><img src="https://img.shields.io/docker/image-size/ambitiousjun/go-emby2openlist/v2.1.2"></img></a>
...
```shell
git clone --branch v2.1.2 --depth 1 https://ghfast.top/https://github.com/AmbitiousJun/go-emby2openlist
cd go-emby2openlist
```
...
参考[示例配置](https://github.com/AmbitiousJun/go-emby2openlist/blob/v2.1.2/config-example.yml)，配置好自己的服务器信息，保存并命名为 `config.yml`
...
services:
  go-emby2openlist:
    image: ambitiousjun/go-emby2openlist:v2.1.2
    environment:
      - TZ=Asia/Shanghai
      - GIN_MODE=release
